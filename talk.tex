...
\begin{document}
  ...
  \begin{frame}{\slidetitle{Untyped \Picalc{}}{Example}}
    ...
    \begin{align*}
        & S \, x \, \is \recv{x}{n} && \mathtt{if} \, n \, \mathtt{\stackrel{?}{=}} \, \mathtt{13} \\
  ...
  \begin{frame}{\slidetitle{Untyped \Picalc{}}{Reduction Relation}}
    \begin{mathpar}
      ...
      \inferrule
      {i \in J}
      {\comp{\select{x}{l_i}P}{\branch{x}{l_j : Q_j}{j \in J}} \reducesto \comp{P}{Q_i}}
      {\rulename{Case}}\\
  ...
  \begin{frame}{\slidetitle{Untyped \Picalc{}}{Example}}
    ...
    \begin{align*}
      ...
      & && \send{x}{0} \branch{x}{ \mathtt{win} : \PO; \mathtt{miss} : C \, x \, 1}{}} \\
      & && \Downarrow \\
      & \new{x} && \comp{\mathtt{if} \, 0 \, \mathtt{\stackrel{?}{=}} \, \mathtt{13} \, \mathtt{then} \, \select{x}{\mathtt{win}} \PO \, \mathtt{else} \, \select{x}{\mathtt{miss}} S \, x}{\\
      & && \branch{x}{ \mathtt{win} : \PO; \mathtt{miss} : C \, x \, 1}{}} \\
      & && \Downarrow \\
      & \new{x} && \comp{\select{x}{\mathtt{miss}} S \, x}{\branch{x}{ \mathtt{win} : \PO; \mathtt{miss} : C \, x \, 1}{}} \\
      & && \Downarrow \\
      & \new{x} && \comp{S \, x}{C \, x \, 1} \\
    \end{align*}
  \end{frame}
