...
\begin{document}
  ...
  \begin{frame}{The Linear \Picalc}
    \begin{itemize}
      \sitem communication channels must be used exactly once
      \sitem privacy; no race conditions
  ...
  \begin{frame}{Co-Contextual Reformulation}
    \begin{itemize}
      ...
      \sitem traverse terms bottom up collecting constraints
      \sitem CSP that results in type substitutions
      \sitem solve constraints eagerly
